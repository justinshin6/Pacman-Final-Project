 ...
 * isTarget to true in the constructor's third parameter.
...
public class BoardCoordinate {
     ...
     * bounded by 0 and the ROW_MAX for the row and the COL_MAX for the column,
     * respectively.
     *
    ...
    private void checkValidity(int row, int column) {
        ...
        } else if (row > ROW_MAX || column > COL_MAX) {
            throw new IllegalArgumentException(
